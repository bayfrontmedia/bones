...
class TenantGroupsModel extends ApiModel implements ScopedResourceInterface
{
    ...
    public function getCollection(string $scoped_id, array $args = []): array
    {
        ...
        if (in_array(Api::ACTION_READ, App::getConfig('api.log.audit.actions'))) {
            ...
            $this->auditLogChannel->info('Tenant group read', [
                'action' => 'api.tenant.group.read',
                'tenant_id' => $scoped_id,
    ...
    public function update(string $scoped_id, string $id, array $attrs): void
    {
        ...
        if (in_array(Api::ACTION_UPDATE, App::getConfig('api.log.audit.actions'))) {
            ...
            $context = [
                'action' => 'api.tenant.group.update',
                'tenant_id' => $scoped_id,
                'group_id' => $id
            ];
            ...
            $this->auditLogChannel->info('Tenant group updated', $context);
