...
class TenantMetaObject implements SchemaInterface
{
    ...
    public static function create(array $array, array $config = []): array
    {
        ...
        if (Arr::isMissing($array, [
            ...
            throw new InvalidSchemaException('Unable to create TenantMetaObject schema: missing required keys');
        }
        ...
        $return['links']['self'] = '/tenants/' . $config['tenant_id'] . '/meta/' . $array['id'] . $query;
